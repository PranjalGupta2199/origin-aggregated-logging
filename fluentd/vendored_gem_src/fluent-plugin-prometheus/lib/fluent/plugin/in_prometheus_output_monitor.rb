  ...
  class PrometheusOutputMonitorInput < Fluent::Input
    ...
    def start
      ...
      @metrics = {
        ...
        total_bytes_received: @registry.gauge(
          :fluentd_total_bytes_received,
          'Total number of bytes received from the input plugin.'),
        total_bytes_stored: @registry.gauge(
          :fluentd_total_bytes_stored,
          'Total number of bytes stored in the buffer plus the number of bytes written to output endpoint.'),
        ...
        total_loglines_received: @registry.gauge(
          :fluentd_total_loglines_received,
          'Total number of log lines received from the input plugin.'),
    ...
    def update_monitor_info
      ...
      monitor_info = {
        ...
        'total_loglines_received' => @metrics[:total_loglines_received],
